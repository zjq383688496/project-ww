		...
		i = function(i) {
			...
			return __extends(r, i), r.prototype.$getEventMap = function(t) {
				...
				var n = this.$EventDispatcher,
					o = r ? n[2] : n[1],
					s = o[t];
				s && (0 !== n[3] && (o[t] = s = s.concat()), this.$removeEventBin(s, e, i), 0 == s.length && (o[t] = null))
				...
				for (var h = 0; s > h; h++) {
					var l = o[h];
					if (l.listener.call(l.thisObject, t), l.dispatchOnce && a.push(l), t.$isPropagationImmediateStopped) break
				}
				for (r[3]--; a.length;) {
					var l = a.pop();
	...
	var i = function(i) {
		...
		return __extends(r, i), r.prototype.$setFlags = function(t) {
			...
			var r = this,
				n = r.$DisplayObject,
				o = n[6];
			return o.equals(t) ? !1 : (o.copyFrom(t), i && (n[0] = o.$getScaleX(), n[1] = o.$getScaleY(), n[2] = t.$getSkewX(), n[3] = t.$getSkewY(), n[16] = e(180 * n[2] / Math.PI), n[17] = e(180 * n[3] / Math.PI), n[4] = e(180 * n[3] / Math.PI)), r.$removeFlags(8), r.$invalidatePosition(), !0)
		...
		}, r.prototype.$measureContentBounds = function(t) {}, r.prototype.$invalidate = function(t) {
			...
			if (e == t.DirtyRegionPolicy.OFF) {
				...
				a.copyFrom(o);
				var h = s.root;
				h !== r.$stage && r.$getConcatenatedMatrixAt(h, a), u.updateRegion(l, a);
			...
			for (var i = this, r = 0, n = 0, o = 0, s = 0; i;) {
				var a = i.$DisplayObject[20];
				if (a && a.length)
					for (var h = a.length, l = 0; h > l; l++) {
						...
						if ("blur" == u.type) {
							...
							var d = u.distance || 0,
								...
								g = 0,
								y = 0;
							0 != d && (g = d * t.NumberUtils.cos(f), g = g > 0 ? Math.ceil(g) : Math.floor(g), y = d * t.NumberUtils.sin(f), y = y > 0 ? Math.ceil(y) : Math.floor(y), r += g, o += g, n += y, s += y)
			...
			return r = Math.min(r, 0), n = Math.min(n, 0), o = Math.max(o, 0), s = Math.max(s, 0), {
				minX: r,
				minY: n,
				maxX: o,
				maxY: s
			...
			if (0 === r.a || 0 === r.d) {
				...
				for (i.identity(); n.$nestLevel > o;) {
					var s = n.$scrollRect;
					s && i.concat(t.$TempMatrix.setTo(1, 0, 0, 1, -s.x, -s.y)), i.concat(n.$getMatrix()), n = n.$parent
				}
			...
			return e
		}, r.prototype.$render = function() {}, r.prototype.$hitTest = function(t, e) {
			var i = this.$DisplayObject;
			...
			if (r) {
				...
				if (h) {
					...
					c.identity(), c.translate(1 - o, 1 - s), t.sys.systemRenderer.render(this, l, c, null, !0), t.Matrix.release(c);
					try {
						a = l.getPixels(1, 1)
					} catch (u) {
						throw new Error(t.sys.tr(1039))
			...
			if (l || e == t.Event.RENDER) {
				var u = l ? r.$enterFrameCallBackList : r.$renderCallBackList; - 1 == u.indexOf(this) && u.push(this)
			}
			...
			for (var r = e.length, n = i - 1, o = 0; r > o; o++) {
				var s = e[o];
				if (t.$currentTarget = s, n > o ? t.$eventPhase = 1 : o == i || o == n ? t.$eventPhase = 2 : t.$eventPhase = 3, s.$notifyListener(t, i > o), t.$isPropagationStopped || t.$isPropagationImmediateStopped) return
			}
		}, r.prototype.willTrigger = function(t) {
			for (var e = this; e;) {
...
! function(t) {
	var e = function(e) {
		...
		return __extends(i, e), i.prototype.$propagateFlagsDown = function(t, e) {
			if (void 0 === e && (e = !1), !this.$hasFlags(t) && (this.$setFlags(t), !e || !this.$displayList))
				for (var i = this.$children, r = i.length, n = 0; r > n; n++) i[n].$propagateFlagsDown(t, e)
			...
			var s = this.$stage;
			if (s && e.$onAddToStage(s, this.$nestLevel + 1), n && e.dispatchEventWith(t.Event.ADDED, !0), s)
			...
			if (this.$childRemoved(o, e), r && o.dispatchEventWith(t.Event.REMOVED, !0), this.$stage) {
				...
				for (var s = i.$EVENT_REMOVE_FROM_STAGE_LIST; s.length > 0;) {
					var a = s.shift();
					r && a.$hasAddToStage && (a.$hasAddToStage = !1, a.dispatchEventWith(t.Event.REMOVED_FROM_STAGE)), a.$hasAddToStage = !1, a.$stage = null
				}
			}
			...
			if (0 != r) {
				for (var n = 0, o = 0, s = 0, a = 0, h = !1, l = -1; r > l; l++) {
					...
					u.isEmpty() || (h ? (n = Math.min(n, u.x), o = Math.max(o, u.x + u.width), s = Math.min(s, u.y), a = Math.max(a, u.y + u.height)) : (h = !0, n = u.x, o = n + u.width, s = u.y, a = s + u.height))
				}
				e.setTo(n, s, o - n, a - s)
			}
			...
			if (e.prototype.$invalidate.call(this, t), t) {
				var i = this.$displayList || this.$parentDisplayList,
					r = this.$children;
				if (r)
					for (var n = r.length - 1; n >= 0; n--) this.markChildDirty(r[n], i)
			}
			...
			if (!t.$hasFlags(512)) {
				...
				if ((i || t.$renderNode) && e && e.markDirty(i || t), !i) {
					var r = t.$children;
					if (r)
						for (var n = r.length - 1; n >= 0; n--) this.markChildDirty(r[n], e)
				}
			}
			...
			if ((t.$renderNode || r) && e && e.markDirty(r || t), !r) {
				var n = t.$children;
				if (n)
					for (var o = n.length - 1; o >= 0; o--) this.assignParentDisplayList(n[o], e, i)
			}
	...
	var e = function(e) {
		...
		return __extends(i, e), i.prototype.$onAddToStage = function(i, r) {
			...
			var e = this.$Bitmap,
				i = e[0];
			if (i)
				if (i instanceof t.Texture) this.setImageData(i._bitmapData, i._bitmapX, i._bitmapY, i._bitmapWidth, i._bitmapHeight, i._offsetX, i._offsetY, i.$getTextureWidth(), i.$getTextureHeight(), i._sourceWidth, i._sourceHeight);
				else {
					var r = i.width,
						n = i.height;
			...
			var r, n = this.$getInvertedConcatenatedMatrix(),
				o = n.a * e + n.c * i + n.tx,
				s = n.b * e + n.d * i + n.ty,
				a = this.$displayList;
			if (a) {
				...
				var u = this.$getRenderNode(),
					c = t.Matrix.create();
				c.identity(), c.translate(1 - o, 1 - s), t.sys.systemRenderer.drawNodeToBuffer(u, h, c, !0), t.Matrix.release(c);
				try {
					r = h.getPixels(1, 1)
				} catch (l) {
					throw console.log(this.$Bitmap[0]), new Error(t.sys.tr(1039))
			...
			console.warn("deprecated method : Bitmap.$drawImage,use egret.sys.BitmapNode.$drawImage instead of it"), t.sys.BitmapNode.$updateTextureData(e, i, r, n, o, s, a, h, l, u, c, p, d, f, g, y, v)
		}, i
	}(t.DisplayObject);
...
! function(t) {
	var e = function(t) {
		function e(e, i, r, n, o, s, a, h) {
			void 0 === e && (e = 16711680), void 0 === i && (i = 1), void 0 === r && (r = 6), void 0 === n && (n = 6), void 0 === o && (o = 2), void 0 === s && (s = 1), void 0 === a && (a = !1), void 0 === h && (h = !1);
			var l = t.call(this) || this;
			return l.type = "glow", l.$color = e, l.$blue = 255 & e, l.$green = (65280 & e) >> 8, l.$red = e >> 16, l.$alpha = i, l.$blurX = r, l.$blurY = n, l.$strength = o, l.$quality = s, l.$inner = a, l.$knockout = h, l.$uniforms.color = {
				x: l.$red / 255,
				y: l.$green / 255,
				z: l.$blue / 255,
				w: 1
			}, l.$uniforms.alpha = i, l.$uniforms.blurX = r, l.$uniforms.blurY = n, l.$uniforms.strength = o, l.$uniforms.inner = a ? 1 : 0, l.$uniforms.knockout = h ? 0 : 1, l
		}
...
! function(t) {
	...
	var e = function(e) {
		...
		return __extends(i, e), Object.defineProperty(i.prototype, "textureWidth", {
			...
			this._bitmapX = e / c, this._bitmapY = i / c, this._bitmapWidth = r / c, this._bitmapHeight = n / c, this._offsetX = o, this._offsetY = s, this._textureWidth = a, this._textureHeight = h, this._sourceWidth = l, this._sourceHeight = u, t.BitmapData.$invalidate(this)
...
function(t) {
	...
	! function(e) {
		function i(e) {
			...
			if (!n) return "{" + e + "}";
			for (var o = i.length, s = 0; o > s; s++) n = n.replace("{" + s + "}", i[s]);
			return n
		}
		e.tr = i
	}(e = t.sys || (t.sys = {}))
	...
	! function(t) {
		var e = function() {
			...
			return t.prototype.moveTo = function(t, e) {
				...
				var h = .5 * i,
					l = .5 * r;
				if (s > h && (s = h), a > l && (a = l), h === s && l === a) return void(s === a ? this.drawCircle(t + s, e + a, s) : this.drawEllipse(t, e, 2 * s, 2 * a));
				var u = t + i,
					c = e + r,
					p = t + s,
					d = u - s,
				...
				o ? n >= r && (n -= 2 * Math.PI) : r >= n && (n += 2 * Math.PI), this.arcToBezier(t, e, i, i, r, n, o)
			}, t.prototype.arcToBezier = function(t, e, i, r, n, o, s) {
				var a = .5 * Math.PI,
					h = n,
					l = h;
				s ? (l += -a - h % a, o > l && (l = o)) : (l += a - h % a, l > o && (l = o));
				...
				for (var p = Math.cos(h), d = Math.sin(h), f = 0; 4 > f; f++) {
					...
					h = l, s ? (l = h - a, o > l && (l = o)) : (l = h + a, l > o && (l = o))
				}
			}, t
		}();
...
! function(t) {
	var e = function(e) {
		...
		return __extends(i, e), i.prototype.getTexture = function(t) {
			...
			void 0 === s && (s = 0), void 0 === a && (a = 0), void 0 === h && (h = s + n), void 0 === l && (l = a + o);
			var u = new t.Texture;
			return u._bitmapData = this.$texture._bitmapData, u.$initData(this._bitmapX + i, this._bitmapY + r, n, o, s, a, h, l, this.$texture._sourceWidth, this.$texture._sourceHeight), this._textureMap[e] = u, u
		}, i.prototype.dispose = function() {
	...
	var e = function() {
		...
		return e.compileProgram = function(i, r, n) {
			var o = e.compileFragmentShader(i, n),
				...
				a = i.createProgram();
			return i.attachShader(a, s), i.attachShader(a, o), i.linkProgram(a), i.getProgramParameter(a, i.LINK_STATUS) || t.$warn(1020), a
...
! function(t) {
	var e = function(e) {
		function i(t, i, r, n, o) {
			...
			return s.bytesLoaded = 0, s.bytesTotal = 0, s.bytesLoaded = n, s.bytesTotal = o, s
		}
...
! function(t) {
	var e = function(e) {
		...
		return __extends(i, e), i.create = function(e, r) {
			...
			var r;
			if (r = e._bitmapData && e._bitmapData.hashCode ? e._bitmapData.hashCode : e.hashCode, r && i._displayList[r])
				for (var n = i._displayList[r], o = 0; o < n.length; o++) n[o] instanceof t.Bitmap && n[o].$refreshImageData(), n[o].$invalidateContentBounds()
		}, i.$dispose = function(e) {
			var r;
			if (r = e._bitmapData && e._bitmapData.hashCode ? e._bitmapData.hashCode : e.hashCode, r && i._displayList[r]) {
				for (var n = i._displayList[r], o = 0, s = n; o < s.length; o++) {
					var a = s[o];
					a instanceof t.Bitmap && (a.$Bitmap[1] = null), a.$invalidateContentBounds()
				}
	...
	var e = new t.Point,
		i = function(i) {
			function r(t, e, r, n, o, s) {
				...
				return a.targetChanged = !0, a.touchDown = !1, a.$initTo(n, o, s), a
			}
...
! function(t) {
	var e = function(t) {
		function e(e, n, o) {
			...
			return s.type = "blur", s.$blurX = e, s.$blurY = n, s.$quality = o, s.blurXFilter = new i(e), s.blurYFilter = new r(n), s
		}
	...
	var i = function(t) {
		function e(e) {
			...
			return i.type = "blurX", i.$uniforms.blur = {
				x: e,
				y: 0
			}, i
		}
	...
	var r = function(t) {
		function e(e) {
			void 0 === e && (e = 4);
			var i = t.call(this) || this;
			return i.type = "blurY", i.$uniforms.blur = {
				x: 0,
				y: e
			}, i
		}
...
! function(t) {
	var e = function(t) {
		...
		return __extends(e, t), Object.defineProperty(e.prototype, "matrix", {
			...
			for (var i = this.$matrix, r = this.$uniforms.matrix, n = this.$uniforms.colorAdd, e = 0, o = 0; e < i.length; e++) 4 === e || 9 === e || 14 === e || 19 === e ? n.x = i[e] : 9 === e ? n.y = i[e] : 14 === e ? n.z = i[e] : 19 === e ? n.w = i[e] : (r[o] = i[e], o++)
		}, e.prototype.$toJson = function() {
...
! function(t) {
	var e, i = {},
		...
		o = 0,
		s = function() {
			for (var t = 0; 36 > t; t++) 8 === t || 13 === t || 18 === t || 23 === t ? n[t] = "-" : 14 === t ? n[t] = "4" : (2 >= o && (o = 33554432 + 16777216 * Math.random() | 0), e = 15 & o, o >>= 4, n[t] = r[19 === t ? 3 & e | 8 : e]);
			return n.join("")
		},
		a = function(t) {
			function e(e, r, n) {
				...
				var a = e + r;
				return i[a] || (i[a] = s()), o.$shaderKey = i[a], o.$uniforms = n, o.type = "custom", o
			}
	...
	t.CustomFilter = a, __reflect(a.prototype, "egret.CustomFilter")
}(egret || (egret = {}));
var egret;
! function(t) {
	var e = function(t) {
		function e(e, i, r, n, o, s, a, h, l, u, c) {
			void 0 === e && (e = 4), void 0 === i && (i = 45), void 0 === r && (r = 0), void 0 === n && (n = 1), void 0 === o && (o = 4), void 0 === s && (s = 4), void 0 === a && (a = 1), void 0 === h && (h = 1), void 0 === l && (l = !1), void 0 === u && (u = !1), void 0 === c && (c = !1);
			var p = t.call(this, r, n, o, s, a, h, l, u) || this;
			return p.$distance = e, p.$angle = i, p.$hideObject = c, p.$uniforms.distance = e, p.$uniforms.angle = i / 180 * Math.PI, p.$uniforms.hideObject = c ? 1 : 0, p
		}
		return __extends(e, t), Object.defineProperty(e.prototype, "distance", {
			...
			set: function(t) {
				this.$distance != t && (this.$distance = t, this.$uniforms.distance = t, this.invalidate())
			},
			enumerable: !0,
			configurable: !0
...
! function(t) {
	...
	var i = function(i) {
		...
		return __extends(r, i), r.prototype.$setTarget = function(t) {
			...
			void 0 === t && (t = 0 / 0), void 0 === e && (e = 0), void 0 === i && (i = 1), void 0 === r && (r = !1), void 0 === n && (n = "normal"), void 0 === o && (o = null), void 0 === s && (s = null), void 0 === a && (a = 3), t = +t || 0, 0 >= t ? (this.strokePath = null, this.setStrokeWidth(0)) : (e = +e || 0, i = +i || 0, a = +a || 0, this.setStrokeWidth(t), this.strokePath = this.$renderNode.lineStyle(t, e, i, o, s, a), this.$renderNode.drawData.length > 1 && this.strokePath.moveTo(this.lastX, this.lastY))
			...
			if (!(0 > r || n === o)) {
				t = +t || 0, i = +i || 0, r = +r || 0, n = +n || 0, o = +o || 0, s = !!s, n = e(n), o = e(o);
				var a = this.fillPath,
					h = this.strokePath;
				a && (a.$lastX = this.lastX, a.$lastY = this.lastY, a.drawArc(t, i, r, n, o, s)), h && (h.$lastX = this.lastX, h.$lastY = this.lastY, h.drawArc(t, i, r, n, o, s)), s ? this.arcBounds(t, i, r, o, n) : this.arcBounds(t, i, r, n, o);
			...
			r > n && (n += 2 * o);
			for (var s = Math.cos(r) * i, a = Math.cos(n) * i, h = Math.min(s, a), l = Math.max(s, a), u = Math.sin(r) * i, c = Math.sin(n) * i, p = Math.min(u, c), d = Math.max(u, c), f = r / (.5 * o), g = n / (.5 * o), y = Math.ceil(f); g >= y; y++) switch (y % 4) {
				case 0:
					l = i;
					break;
				case 1:
			...
			var h = this.$renderNode,
				l = t.Matrix.create();
			l.identity(), l.translate(1 - o, 1 - s), t.sys.canvasRenderer.drawNodeToBuffer(h, a, l, !0), t.Matrix.release(l);
			try {
	...
	var e = Math.PI,
		...
		o = function(o) {
			function s(t, e, i, r, n, s) {
				void 0 === t && (t = 1), void 0 === e && (e = 0), void 0 === i && (i = 0), void 0 === r && (r = 1), void 0 === n && (n = 0), void 0 === s && (s = 0);
				var a = o.call(this) || this;
				return a.a = t, a.b = e, a.c = i, a.d = r, a.tx = n, a.ty = s, a
			}
			return __extends(s, o), s.release = function(t) {
				t && n.push(t)
			}, s.create = function() {
				var t = n.pop();
				return t || (t = new s), t
				...
				var e = this.a,
					...
					o = this.tx,
					s = this.ty;
				if (0 == i && 0 == r) return t.b = t.c = 0, void(0 == e || 0 == n ? t.a = t.d = t.tx = t.ty = 0 : (e = t.a = 1 / e, n = t.d = 1 / n, t.tx = -e * o, t.ty = -n * s));
				var a = e * n - i * r;
				if (0 == a) return void t.identity();
				a = 1 / a;
				var h = t.a = n * a;
				i = t.b = -i * a, r = t.c = -r * a, n = t.d = e * a, t.tx = -(h * o + r * s), t.ty = -(i * o + n * s)
				...
				if (e = +e, 0 !== e) {
					...
					var i = t.NumberUtils.cos(e),
						...
						l = this.tx,
						u = this.ty;
					this.a = o * i - s * n, this.b = o * n + s * i, this.c = a * i - h * n, this.d = a * n + h * i, this.tx = l * i - u * n, this.ty = l * n + u * i
				}
				...
				if (1 != t || 0 != e || 0 != i || 1 != r) {
					var a = this.a,
						h = this.c;
					this.a = a * t + this.b * i, this.b = a * e + this.b * r, this.c = h * t + this.d * i, this.d = h * e + this.d * r
				}
				return this.tx = s * t + this.ty * i + n, this.ty = s * e + this.ty * r + o, this
				...
				var e = this.a,
					...
					$ = i * a + n * u + s,
					m = 0;
				c > d && (m = c, c = d, d = m), g > v && (m = g, g = v, v = m), t.x = Math.floor(g > c ? c : g), t.width = Math.ceil((d > v ? d : v) - t.x), p > f && (m = p, p = f, f = m), y > $ && (m = y, y = $, $ = m), t.y = Math.floor(y > p ? p : y), t.height = Math.ceil((f > $ ? f : $) - t.y)
				...
				if (!(0 != o && o != i || 0 != s && s != i)) return this.a = e, this.b = this.c = 0, void(this.d = n);
				o /= r, s /= r;
				var a = t.NumberUtils.cos(o),
					h = t.NumberUtils.sin(o);
				o == s ? (this.a = a * e, this.b = h * e) : (this.a = t.NumberUtils.cos(s) * e, this.b = t.NumberUtils.sin(s) * e), this.c = -h * n, this.d = a * n
		...
		var r = function() {
			...
			return r.prototype.setClipRect = function(t, e) {
				...
				var r = i.minX,
					...
					o = i.maxX,
					s = i.maxY;
				if (this.hasClipRect && (0 > r && (r = 0), 0 > n && (n = 0), o > this.clipWidth && (o = this.clipWidth), s > this.clipHeight && (s = this.clipHeight)), r >= o || n >= s) return !1;
				if (this.clipRectChanged) return !0;
				var a = this.dirtyList,
					h = e.Region.create();
				return a.push(h.setTo(r, n, o, s)), this.$dirtyRegionPolicy != t.DirtyRegionPolicy.OFF && this.mergeDirtyList(a), !0
			}, r.prototype.clear = function() {
				for (var t = this.dirtyList, i = t.length, r = 0; i > r; r++) e.Region.release(t[r]);
				t.length = 0
				...
				if (this.$dirtyRegionPolicy == t.DirtyRegionPolicy.OFF) {
					...
					if (this.hasClipRect) i.push(r.setTo(0, 0, this.clipWidth, this.clipHeight));
					else {
				...
				if (o > 0)
					for (var s = 0; o > s; s++) this.dirtyList[s].intValues();
				...
				if (n && h / this.clipArea > .95 && (this.clipRectChanged = !0), s != a) {
					var f = t[a];
		...
		var i = function(i) {
			...
			return __extends(r, i), r.create = function(i) {
				...
				if (e == t.DirtyRegionPolicy.OFF) {
					...
					if (this.needUpdateRegions && this.updateDirtyRegions(), !o) return !1;
					...
					var h = i.$getOriginalBounds(),
						...
						l = r.renderRegion;
					if (this.needUpdateRegions && this.updateDirtyRegions(), !o) return l.setTo(0, 0, 0, 0), r.moved = !1, !1;
					if (!r.moved) return !1;
					r.moved = !1;
					var s = r.renderMatrix;
					s.copyFrom(n);
					var a = o.root;
					a !== i.$stage && i.$getConcatenatedMatrixAt(a, s), l.updateRegion(h, s)
				}
				return !0
				...
				if (r && r.length > 0) {
					...
					if (n.beginClip(this.dirtyList, this.offsetX, this.offsetY), r = this.$dirtyRegionPolicy == t.DirtyRegionPolicy.OFF ? null : this.dirtyList, i = e.systemRenderer.render(this.root, n, this.offsetMatrix, r), n.endClip(), !this.isStage) {
						var o = n.surface,
							s = this.$renderNode;
						s.drawData.length = 0;
						var a = o.width,
							h = o.height;
						this.bitmapData ? (this.bitmapData.source = o, this.bitmapData.width = a, this.bitmapData.height = h) : this.bitmapData = new t.BitmapData(o), s.image = this.bitmapData, s.imageWidth = a, s.imageHeight = h, s.drawImage(0, 0, a, h, -this.offsetX, -this.offsetY, a, h)
					}
				}
				...
				(this.offsetX != t || this.offsetY != e || r.surface.width != n || r.surface.height != o) && (this.sizeChanged ? r.resizeTo(n, o, this.offsetX - t, this.offsetY - e) : (this.sizeChanged = !0, r.resize(n, o)))
			}, r.prototype.setDirtyRegionPolicy = function(t) {
				this.$dirtyRegionPolicy = t, this.dirtyRegion.setDirtyRegionPolicy(t), this.renderBuffer.setDirtyRegionPolicy(t)
			}, r
		}(t.HashObject);
		e.DisplayList = i, __reflect(i.prototype, "egret.sys.DisplayList", ["egret.sys.Renderable"])
	}(e = t.sys || (t.sys = {}))
}(egret || (egret = {}));
var egret;
! function(t) {}(egret || (egret = {}));
	...
	! function(e) {
		...
		function n(t) {
			...
			var s = this.screenDisplayList.renderBuffer,
				a = s.context;
			a.setTransform(1, 0, 0, 1, 0, 0), a.clearRect(0, 0, s.surface.width, s.surface.height), a.drawImage(this.stageDisplayList.renderBuffer.surface, 0, 0), e = o.length;
			for (var r = 0; e > r; r++) {
				i = o[r];
			...
			for (var r = 0; e > r; r++) {
				var n = t[r];
				a.clearRect(n.minX, n.minY, n.width, n.height), a.rect(n.minX, n.minY, n.width, n.height)
			}
		...
		var a = function(s) {
			function a(t, e, a) {
				...
				return h.isPlaying = !1, h.entryClassName = a, h.stage = e, h.screenDisplayList = h.createDisplayList(e, t), h.showFPS = !1, h.showLog = !1, h._showPaintRect = !1, h.stageDisplayList = null, h.paintList = [], h.displayFPS = i, h.showPaintRect = r, h.drawPaintRect = n, h.drawDirtyRect = o, h
			}
			return __extends(a, s), a.prototype.createDisplayList = function(t, i) {
		...
		e.$logToFPS = function(t) {
			...
			function r(e, r, n, o, s) {
				i.call(this), this.isFPS = !0, this.infoLines = [], this.totalTime = 0, this.totalTick = 0, this.lastTime = 0, this.drawCalls = 0, this.dirtyRatio = 0, this.costDirty = 0, this.costRender = 0, this.costTicker = 0, this._stage = e, this.showFPS = r, this.showLog = n, this.logFilter = o, this.touchChildren = !1, this.touchEnabled = !1, this.styles = s, this.fpsDisplay = new t.FPSDisplay(e, r, n, o, s), this.addChild(this.fpsDisplay);
				var a;
				try {
			...
			return __extends(r, i), r.prototype.update = function(i, r, n, o, s) {
				var a = t.getTimer();
				if (this.totalTime += a - this.lastTime, this.lastTime = a, this.totalTick++, this.drawCalls += i, this.dirtyRatio += r, this.costDirty += n, this.costRender += o, this.costTicker += s, this.totalTime >= 1e3) {
			...
			i = function() {
				...
				return t.release = function(t) {
					...
					var i, r, n, o, s = e,
						...
						g = d + t.width,
						y = f + t.height;
					if (1 == a && 0 == h && 0 == l && 1 == u) i = d + c - 1, r = f + p - 1, n = g + c + 1, o = y + p + 1;
					else {
						var v = a * d + l * f + c,
							$ = h * d + u * f + p,
							m = a * g + l * f + c,
							...
							O = h * d + u * y + p,
							E = 0;
						v > m && (E = v, v = m, m = E), x > _ && (E = x, x = _, _ = E), i = (x > v ? v : x) - 1, n = (m > _ ? m : _) + 1, $ > b && (E = $, $ = b, b = E), T > O && (E = T, T = O, O = E), r = (T > $ ? $ : T) - 1, o = (b > O ? b : O) + 1
					}
	...
	! function(e) {
		...
		var i = function() {
			...
			return i.prototype.$addPlayer = function(t) {
				...
				if (this.lastTimeStamp = a, u >= this.frameDeltaTime) this.lastCount = this.frameInterval;
				else {
					if (this.lastCount -= 1e3, this.lastCount > 0) return void(s && this.render(!1, this.costEnterFrame + l - i));
...
! function(t) {
	...
	! function(e) {
		var i = function(e) {
			function i() {
				var t = e.call(this) || this;
				return t.image = null, t.smoothing = !0, t.blendMode = null, t.alpha = 0 / 0, t.filter = null, t.type = 1, t
			}
			return __extends(i, e), i.prototype.drawImage = function(t, e, i, r, n, o, s, a) {
				...
				if (r) {
					...
					if (e.smoothing = $, e.image = r, e.imageWidth = f, e.imageHeight = g, y) i.$updateTextureDataWithScale9Grid(e, y, n, o, s, a, h, l, u, c, p, d);
					else if (v == t.BitmapFillMode.SCALE) {
						var b = p / u * m,
							x = d / c * m;
						e.drawImage(n, o, s, a, b * h, x * l, b * s, x * a)
				...
				var d = o,
					f = s;
				c -= l - o * t.$TextureScaleFactor, p -= u - s * t.$TextureScaleFactor;
				var g = i.x - a,
					y = i.y - h,
				...
				if ((v + O) * t.$TextureScaleFactor > c || ($ + C) * t.$TextureScaleFactor > p) return void e.drawImage(r, n, o, s, a, h, c, p);
				var P = a,
					D = P + g,
					L = P + (c - R),
					M = c - g - R,
					...
					B = A + p - S,
					I = p - y - S;
				$ > 0 && (v > 0 && e.drawImage(x, E, v, $, P, A, g, y), m > 0 && e.drawImage(T, E, m, $, D, A, M, y), O > 0 && e.drawImage(_, E, O, $, L, A, R, y)), b > 0 && (v > 0 && e.drawImage(x, F, v, b, P, N, g, I), m > 0 && e.drawImage(T, F, m, b, D, N, M, I), O > 0 && e.drawImage(_, F, O, b, L, N, R, I)), C > 0 && (v > 0 && e.drawImage(x, w, v, C, P, B, g, S), m > 0 && e.drawImage(T, w, m, C, D, B, M, S), O > 0 && e.drawImage(_, w, O, C, L, B, R, S))
			}, i.drawClipImage = function(t, e, i, r, n, o, s, a, h, l, u, c) {
				void 0 === u && (u = 0), void 0 === c && (c = 0);
				var p = s + n - h;
				p > 0 && (n -= p), p = a + o - l, p > 0 && (o -= p), t.drawImage(i, r, n / e, o / e, u + s, c + a, n, o)
			}, i
		}(e.RenderNode);
		...
		var i = ["none", "round", "square"],
			...
			n = function(n) {
				...
				return __extends(o, n), o.prototype.beginFill = function(t, i, r) {
					...
					if (l.gradientType = i, l.colors = r, l.alphas = n, l.ratios = o, l.matrix = h, a) {
					...
					void 0 === s && (s = 1), void 0 === l && (l = 3), -1 == i.indexOf(a) && (a = "round"), -1 == r.indexOf(h) && (h = "round");
					var u = new e.StrokePath;
					return u.lineWidth = n, u.lineColor = o, u.lineAlpha = s, u.caps = a || t.CapsStyle.ROUND, u.joints = h, u.miterLimit = l, this.drawData.push(u), u
...
! function(t) {
	...
	! function(e) {
		var i = function(e) {
			...
			return __extends(i, e), i.prototype.drawMesh = function(t, e, i, r, n, o, s, a) {
				this.drawData.push(t, e, i, r, n, o, s, a), this.renderCount++
			}, i.prototype.cleanBeforeRender = function() {
...
! function(t) {
	var e = function(e) {
		...
		return __extends(i, e), i.prototype.drawToTexture = function(e, i, r) {
			...
			if (!a) return !1;
			a.resize(o, s), this._bitmapData.width = o, this._bitmapData.height = s;
			var h = t.Matrix.create();
			return h.identity(), i && h.translate(-i.x, -i.y), h.scale(r, r), t.sys.systemRenderer.render(e, a, h, null, !0), t.Matrix.release(h), this.$initData(0, 0, o, s, 0, 0, o, s, o, s), !0
...
! function(t) {
	...
	function r(e, r, n, o, s, a) {
		...
		for (var l = n.length, u = 0; l > u; u++) h.addColorStop(s[u] / 255, i(n[u], o[u]));
		return h
	}
	...
	function o(t, e, i, r) {
		for (var n = r[0], o = r[1], s = r[2], a = r[3], h = r[4], l = r[5], u = r[6], c = r[7], p = r[8], d = r[9], f = r[10], g = r[11], y = r[12], v = r[13], $ = r[14], m = r[15], b = r[16], x = r[17], T = r[18], _ = r[19], O = 0, E = e * i * 4; E > O; O += 4) {
			var F = t[O + 0],
				w = t[O + 1],
				C = t[O + 2],
				R = t[O + 3];
			t[O + 0] = n * F + o * w + s * C + a * R + h, t[O + 1] = l * F + u * w + c * C + p * R + d, t[O + 2] = f * F + g * w + y * C + v * R + $, t[O + 3] = m * F + b * w + x * C + T * R + _
		}
	}
	...
	function a(t, e, i, r) {
		...
		for (var s = 4 * e, a = 2 * r + 1, h = 0; i > h; h++) {
			for (var l = h * s, u = 0, c = 0, p = 0, d = 0, f = 0, g = 0, y = 4 * -r, v = 4 * r + 4; v > y; y += 4) {
				var $ = l + y;
				l > $ || $ >= l + s || (f = t[$ + 3], u += t[$ + 0] * f, c += t[$ + 1] * f, p += t[$ + 2] * f, d += f)
			}
			for (var y = l, v = l + s, m = 0, b = y - 4 * r, x = y + 4 * (r + 1); v > y; y += 4, m += 4, x += 4, b += 4) 0 === d ? (o[m + 0] = 0, o[m + 1] = 0, o[m + 2] = 0, o[m + 3] = 0) : (o[m + 0] = u / d, o[m + 1] = c / d, o[m + 2] = p / d, o[m + 3] = d / a), f = t[x + 3], g = t[b + 3], f || 0 == f ? g || 0 == g ? (u += t[x + 0] * f - t[b + 0] * g, c += t[x + 1] * f - t[b + 1] * g, p += t[x + 2] * f - t[b + 2] * g, d += f - g) : (u += t[x + 0] * f, c += t[x + 1] * f, p += t[x + 2] * f, d += f) : (g || 0 == g) && (u += -t[b + 0] * g, c += -t[b + 1] * g, p += -t[b + 2] * g, d += -g);
			_ ? t.set(o, l) : n(t, o, l)
		}
	}
	...
	function h(t, e, i, r) {
		...
		for (var o = 4 * e, s = 2 * r + 1, a = 0; e > a; a++) {
			for (var h = 4 * a, l = 0, u = 0, c = 0, p = 0, d = 0, f = 0, g = -r * o, y = r * o + o; y > g; g += o) {
				var v = h + g;
				h > v || v >= h + i * o || (d = t[v + 3], l += t[v + 0] * d, u += t[v + 1] * d, c += t[v + 2] * d, p += d)
			}
			for (var g = h, y = h + i * o, $ = 0, m = h - r * o, b = h + (r + 1) * o; y > g; g += o, $ += 4, b += o, m += o) 0 === p ? (n[$ + 0] = 0, n[$ + 1] = 0, n[$ + 2] = 0, n[$ + 3] = 0) : (n[$ + 0] = l / p, n[$ + 1] = u / p, n[$ + 2] = c / p, n[$ + 3] = p / s), d = t[b + 3], f = t[m + 3], d || 0 == d ? f || 0 == f ? (l += t[b + 0] * d - t[m + 0] * f, u += t[b + 1] * d - t[m + 1] * f, c += t[b + 2] * d - t[m + 2] * f, p += d - f) : (l += t[b + 0] * d, u += t[b + 1] * d, c += t[b + 2] * d, p += d) : (f || 0 == f) && (l += -t[m + 0] * f, u += -t[m + 1] * f, c += -t[m + 2] * f, p += -f);
			for (var x = 4 * a, y = x + i * o, T = 0; y > x; x += o, T += 4) t[x + 0] = n[T + 0], t[x + 1] = n[T + 1], t[x + 2] = n[T + 2], t[x + 3] = n[T + 3]
		}
	}

	function l(t, e, i, r, o, a, h, l, f) {
		var g = u(t, r);
		c(g, e, i, h, l), s(g, e, i, o, a), p(g, f), d(g, t), t.set(g), _ ? t.set(g) : n(t, g)
	}
		...
		if (_) {
			...
			for (var u = 0; i > u; u++) {
				...
				if (!(0 > c || c > i))
					for (var p = 0; e > p; p++) {
						var d = p + l;
						0 > d || d > e || (a[4 * (c * e + d) + 0] = s[4 * (u * e + p) + 0], a[4 * (c * e + d) + 1] = s[4 * (u * e + p) + 1], a[4 * (c * e + d) + 2] = s[4 * (u * e + p) + 2], a[4 * (c * e + d) + 3] = s[4 * (u * e + p) + 3])
					}
			}
			n(s, a)
		}
	...
	function g(t, e, i, r, o, s, a, h, l, u, c, p) {
		...
		for (var g, y, v = r[3], $ = 0, m = 0, b = h * Math.cos(a), x = h * Math.sin(a), T = 7, O = 12, E = 3.141592653589793, F = o / T, w = s / T, C = 0; e > C; C++)
			for (var R = 0; i > R; R++) {
				for (var S = 0, P = R * e * 4 + 4 * C, D = 0, L = 0, M = t[P + 0] / 255, A = t[P + 1] / 255, N = t[P + 2] / 255, B = t[P + 3] / 255, I = 0; 2 * E >= I; I += 2 * E / O) {
				...
				var G = W / (W + B),
					...
					Q = f(Z, r[2], q),
					te = Math.min(B + H + W, 1);
				d[P + 0] = 255 * J, d[P + 1] = 255 * K, d[P + 2] = 255 * Q, d[P + 3] = 255 * te
			}
		_ ? t.set(d) : n(t, d)
	}
	var y = ["source-over", "lighter", "destination-out"],
		...
		T = function() {
			...
			return n.prototype.render = function(t, e, i, r, n) {
				...
				var h, l = 0;
				if (o && !a ? (o.isDirty && (l += o.drawToSurface()), h = o.$renderNode) : h = e.$getRenderNode(), h) {
					if (r) {
					...
					if (h.needRedraw) {
						var d = void 0,
							f = void 0;
						a ? (d = e.$getConcatenatedAlphaAt(a, e.$getConcatenatedAlpha()), f = t.Matrix.create().copyFrom(e.$getConcatenatedMatrix()), e.$getConcatenatedMatrixAt(a, f), n.$preMultiplyInto(f, f), i.setTransform(f.a, f.b, f.c, f.d, f.tx, f.ty), t.Matrix.release(f)) : (d = h.renderAlpha, f = h.renderMatrix, i.setTransform(f.a, f.b, f.c, f.d, f.tx + n.tx, f.ty + n.ty)), i.globalAlpha = d, l += this.renderNode(h, i), h.needRedraw = !1
					}
				}
				if (o && !a) return l;
				var g = e.$children;
				...
				if (E += e.$mask && (e.$mask.$parentDisplayList || h) ? this.drawWithClip(e, L, r, M, S, h) : e.$scrollRect || e.$maskRect ? this.drawWithScrollRect(e, L, r, M, S, h) : this.drawDisplayObject(e, L, r, M, e.$displayList, S, h), t.Matrix.release(M), E > 0) {
					C && (i.globalCompositeOperation = O), E++, i.globalAlpha = 1, i.setTransform(1, 0, 0, 1, S.minX + n.tx, S.minY + n.ty);
					for (var A = L.getImageData(0, 0, D.surface.width, D.surface.height), N = 0; w > N; N++) {
						var B = F[N];
						if ("colorTransform" == B.type) o(A.data, D.surface.width, D.surface.height, B.$matrix);
						else if ("blur" == B.type) s(A.data, D.surface.width, D.surface.height, B.$blurX, B.$blurY);
						else if ("glow" == B.type) {
							var I = B.$red,
								j = B.$green,
								k = B.$blue,
								U = B.$alpha;
							B.$inner || B.$knockout || B.$hideObject ? g(A.data, D.surface.width, D.surface.height, [I / 255, j / 255, k / 255, U], B.$blurX, B.$blurY, B.$angle ? B.$angle / 180 * Math.PI : 0, B.$distance || 0, B.$strength, B.$inner ? 1 : 0, B.$knockout ? 0 : 1, B.$hideObject ? 1 : 0) : l(A.data, D.surface.width, D.surface.height, [I / 255, j / 255, k / 255, U / 255], B.$blurX, B.$blurY, B.$angle ? B.$angle / 180 * Math.PI : 0, B.$distance || 0, B.$strength)
						} else "custom" == B.type
					}
					L.putImageData(A, 0, 0), i.drawImage(D.surface, 0, 0), C && (i.globalCompositeOperation = v)
				}
				...
				if (p) {
					...
					x.copyFrom(p.$getConcatenatedMatrix()), f.updateRegion(m, x), t.Matrix.release(x)
				}
				var T;
				...
				if (!(p || e.$children && 0 != e.$children.length)) {
					if (c) {
						var x = g;
						i.save(), i.setTransform(x.a, x.b, x.c, x.d, x.tx - T.minX, x.ty - T.minY), i.beginPath(), i.rect(c.x, c.y, c.width, c.height), i.clip()
					}
					return l && (i.globalCompositeOperation = a), h += this.drawDisplayObject(e, i, r, n, e.$displayList, o, s), l && (i.globalCompositeOperation = v), c && i.restore(), h
				}
				if (p && t.Capabilities.$runtimeType == t.RuntimeType.WEB && (!p.$children || 0 == p.$children.length) && u && 3 == u.type && 1 == u.drawData.length && 1 == u.drawData[0].type && 1 == u.drawData[0].fillAlpha) {
					...
					if (this.renderingMask = !1, c) {
						var x = g;
						i.setTransform(x.a, x.b, x.c, x.d, x.tx - T.minX, x.ty - T.minY), i.beginPath(), i.rect(c.x, c.y, c.width, c.height), i.clip()
					}
					return F += this.drawDisplayObject(e, i, r, n, e.$displayList, o, s), i.restore(), F
				}
				var w = this.createRenderBuffer(T.width, T.height),
					C = w.context;
				if (!C) return h += this.drawDisplayObject(e, i, r, n, e.$displayList, o, s), t.sys.Region.release(T), t.Matrix.release(g), h;
				C.setTransform(1, 0, 0, 1, -T.minX, -T.minY);
				var R = t.Matrix.create().setTo(1, 0, 0, 1, -T.minX, -T.minY);
				if (h += this.drawDisplayObject(e, C, r, R, e.$displayList, T, s), p)
					if (t.Capabilities.$runtimeType == t.RuntimeType.WEB && u && 1 == u.$getRenderCount() || p.$displayList) C.globalCompositeOperation = "destination-in", h += this.drawDisplayObject(p, C, r, R, p.$displayList, T, s);
					else {
						var S = this.createRenderBuffer(T.width, T.height),
							P = S.context;
						if (!P) return h += this.drawDisplayObject(e, i, r, n, e.$displayList, o, s), b.push(w), t.sys.Region.release(T), t.Matrix.release(g), h;
						P.setTransform(1, 0, 0, 1, -T.minX, -T.minY), R = t.Matrix.create().setTo(1, 0, 0, 1, -T.minX, -T.minY), h += this.drawDisplayObject(p, P, r, R, p.$displayList, T, s), C.globalCompositeOperation = "destination-in", C.setTransform(1, 0, 0, 1, 0, 0), C.globalAlpha = 1, C.drawImage(S.surface, 0, 0), b.push(S)
					}
				if (t.Matrix.release(R), h > 0) {
					...
					i.globalAlpha = 1, i.setTransform(1, 0, 0, 1, T.minX + n.tx, T.minY + n.ty), i.drawImage(w.surface, 0, 0), c && i.restore(), l && (i.globalCompositeOperation = v)
				}
				...
				if (l.copyFrom(e.$getConcatenatedMatrix()), s) e.$getConcatenatedMatrixAt(s, l);
				...
				if (c.updateRegion(h, l), c.isEmpty() || o && !o.intersects(c)) return t.sys.Region.release(c), t.Matrix.release(l), a;
				var p = !1;
				if (r) {
				...
				return p ? (i.save(), i.setTransform(l.a, l.b, l.c, l.d, l.tx + n.tx, l.ty + n.ty), i.beginPath(), i.rect(h.x, h.y, h.width, h.height), i.clip(), a += this.drawDisplayObject(e, i, r, n, e.$displayList, c, s), i.restore(), t.sys.Region.release(c), t.Matrix.release(l), a) : (t.sys.Region.release(c), t.Matrix.release(l), a)
				...
				var r = e.image,
					...
					s = 0,
					a = e.matrix;
				for (a && (i.saveTransform(), i.transform(a.a, a.b, a.c, a.d, a.tx, a.ty)); o > s;) i.drawMesh(r.source, n[s++], n[s++], n[s++], n[s++], n[s++], n[s++], n[s++], n[s++], e.imageWidth, e.imageHeight, e.uvs, e.vertices, e.indices, e.bounds);
				...
				if (f && 8 == s)
					if (t.Capabilities.runtimeType == t.RuntimeType.NATIVE) {
						for (egret_native.Graphics.setGlobalShader(f); s > a;) d++, i.drawImage(r.source, n[a++], n[a++], n[a++], n[a++], n[a++], n[a++], n[a++], n[a++]);
						egret_native.Graphics.setGlobalShader(null)
					} else {
						var g = this.createRenderBuffer(n[6], n[7]),
							$ = g.context;
						d++, $.drawImage(r.source, n[0], n[1], n[2], n[3], 0, 0, n[6], n[7]), d++;
						var m = $.getImageData(0, 0, g.surface.width, g.surface.height);
						o(m.data, g.surface.width, g.surface.height, f.$matrix), $.putImageData(m, 0, 0), i.drawImage(g.surface, 0, 0, n[6], n[7], n[4], n[5], n[6], n[7]), b.push(g)
					}
				else
					for (; s > a;) d++, i.drawImage(r.source, n[a++], n[a++], n[a++], n[a++], n[a++], n[a++], n[a++], n[a++]);
				return c ? i.restoreTransform ? (i.restoreTransform(), l && (i.globalCompositeOperation = v), u == u && (i.globalAlpha = p)) : i.restore() : (l && (i.globalCompositeOperation = v), u == u && (i.globalAlpha = p)), d
				...
				for (var n = i.drawData, o = n.length, s = 0; o > s;) {
					...
					r.fillStyle = t.toColorString(c), r.strokeStyle = t.toColorString(p), d && (r.lineWidth = 2 * d, r.strokeText(l, a, h)), r.fillText(l, a, h)
				}
				...
				for (var a = 0; s > a; a++) {
					...
					switch (h.type) {
						case 1:
							var l = h;
							e.fillStyle = n ? $ : i(l.fillColor, l.fillAlpha), this.renderPath(h, e), this.renderingMask ? e.clip() : e.fill();
							break;
						case 2:
							var u = h;
							e.fillStyle = n ? $ : r(e, u.gradientType, u.colors, u.alphas, u.ratios, u.matrix), e.save();
							var c = u.matrix;
						...
						case 3:
							var p = h,
								d = p.lineWidth;
							e.lineWidth = d, e.strokeStyle = n ? $ : i(p.lineColor, p.lineAlpha), e.lineCap = m[p.caps], e.lineJoin = p.joints, e.miterLimit = p.miterLimit;
							var f = 1 === d || 3 === d;
		...
		return __extends(e, t), e.prototype.getTexture = function(t) {
			...
			for (var e = t.split("\n"), i = this.getConfigByKey(e[3], "count"), r = {}, n = 4; 4 + i > n; n++) {
				var o = e[n],
					...
					a = {};
				r[s] = a, a.x = this.getConfigByKey(o, "x"), a.y = this.getConfigByKey(o, "y"), a.w = this.getConfigByKey(o, "width"), a.h = this.getConfigByKey(o, "height"), a.offX = this.getConfigByKey(o, "xoffset"), a.offY = this.getConfigByKey(o, "yoffset"), a.xadvance = this.getConfigByKey(o, "xadvance")
			}
			return r
...
! function(t) {
	var e = function(e) {
		function i() {
			var i = e.call(this) || this;
			return i.$textOffsetX = 0, i.$textOffsetY = 0, i.$textStartX = 0, i.$textStartY = 0, i.$lineHeights = [], i.$renderNode = new t.sys.BitmapNode, i.$BitmapText = {
				0: 0 / 0,
				1: 0 / 0,
				2: "",
				3: 0,
		...
		return __extends(i, e), Object.defineProperty(i.prototype, "smoothing", {
			...
			if (0 != n) {
				var o = this.$textLinesWidth,
					s = e[5],
					a = this.$renderNode;
				s.$texture && (a.image = s.$texture._bitmapData), a.smoothing = e[12];
					...
					for (var _ = 0; b > _; _++) {
						...
						if (E) {
							var F = E._bitmapWidth,
								w = E._bitmapHeight;
							a.imageWidth = E._sourceWidth, a.imageHeight = E._sourceHeight, a.drawImage(E._bitmapX, E._bitmapY, F, w, x + E._offsetX, g + E._offsetY, E.$getScaleBitmapWidth(), E.$getScaleBitmapHeight()), x += (s.getConfig(O, "xadvance") || E.$getTextureWidth()) + e[4]
			...
			function e(t) {
				return m && n.length > 0 && f > m ? !1 : (f += l + c, a || h || (u -= p), n.push(t), s.push(l), o.push(u), d = Math.max(u, d), !0)
			}
			...
			for (var a, h, l, u, c = r[3], p = r[4], d = 0, f = 0, g = 0, y = 0, v = !isNaN(r[0]), $ = r[0], m = r[1], b = r[5], x = b._getFirstCharHeight(), T = Math.ceil(x * i.EMPTY_FACTOR), _ = r[2], O = _.split(/(?:\r\n|\r|\n)/), E = O.length, F = !0, w = 0; E > w; w++) {
				var C = O[w],
					R = C.length;
				l = 0, u = 0, a = !0, h = !1;
				for (var S = 0; R > S; S++) {
					...
					var P = C.charAt(S),
						...
						A = 0,
						N = b.getTexture(P);
					if (N) D = N.$getTextureWidth(), L = N.$getTextureHeight(), M = N._offsetX, A = N._offsetY;
					else {
						if (" " != P) {
							t.$warn(1046, P), a && (a = !1);
							continue
					...
					if (a && (a = !1, g = Math.min(M, g)), F && (F = !1, y = Math.min(A, y)), v && S > 0 && u + D > $) {
						if (!e(C.substring(0, S))) break;
						C = C.substring(S), R = C.length, S = 0, u = S == R - 1 ? D : b.getConfig(P, "xadvance") || D, l = L
					} else u += S == R - 1 ? D : b.getConfig(P, "xadvance") || D, l = Math.max(L, l)
				}
				if (m && w > 0 && f > m) break;
				if (h = !0, !e(C)) break
			}
			...
			var B;
			return $ > d && (B = r[10], B == t.HorizontalAlign.RIGHT ? this.$textStartX = $ - d : B == t.HorizontalAlign.CENTER && (this.$textStartX = Math.floor(($ - d) / 2))), m > f && (B = r[11], B == t.VerticalAlign.BOTTOM ? this.$textStartY = m - f : B == t.VerticalAlign.MIDDLE && (this.$textStartY = Math.floor((m - f) / 2))), n
		}, i
	}(t.DisplayObject);
		...
		return e.prototype.initReplaceArr = function() {
			...
			for (var i = 0, r = e.length; r > i;) {
				...
				if (0 > n) this.addToResultArr(e.substring(i)), i = r;
					...
					var o = e.indexOf(">", n); - 1 == o ? (t.$error(1038), o = n) : "/" == e.charAt(n + 1) ? this.stackArray.pop() : this.addToArray(e.substring(n + 1, o)), i = o + 1
				}
			}
			...
			if ("i" == t.charAt(0) || "b" == t.charAt(0) || "u" == t.charAt(0)) this.addProperty(e, t, "true");
				...
				for (var r = 0, n = void 0; n = t.match(this.getHeadReg());) {
					var o = n[0],
						s = "";
					t = t.substring(o.length).trim(), '"' == t.charAt(0) ? (r = t.indexOf('"', 1), s = t.substring(1, r), r += 1) : "'" == t.charAt(0) ? (r = t.indexOf("'", 1), s = t.substring(1, r), r += 1) : (s = t.match(/(\S)+/)[0], r = s.length), this.addProperty(e, o.substring(0, o.length - 1).trim(), s.trim()), t = t.substring(r).trim()
				}
			}
			return e
	...
	var e = function(e) {
		...
		return __extends(i, e), i.prototype.init = function(e) {
			...
			var i, r, n = this._text.$TextField,
				...
				s = !1;
			null != n[35] && (i = new RegExp("[" + n[35] + "]", "g"), r = o.match(i), o = r ? r.join("") : "", s = !0), null != n[36] && (i = new RegExp("[^" + n[36] + "]", "g"), r = o.match(i), o = r ? r.join("") : "", s = !0), s && this.stageText.$getText() != o && this.stageText.$setText(o), this.resetText(), this._text.dispatchEvent(new t.Event(t.Event.CHANGE, !0))
		...
		r = function(r) {
			...
			return __extends(n, r), n.prototype.isInput = function() {
				...
				if (r[33] || r[31] || e && e.length > 0) {
					...
					var o = void 0,
						s = void 0;
					if (r[33] && (o = i.beginFill(r[34]), o.drawRect(0, 0, this.$getWidth(), this.$getHeight())), r[31] && (s = i.lineStyle(1, r[32]), s.drawRect(0, 0, this.$getWidth() - 1, this.$getHeight() - 1)), e && e.length > 0)
						for (var a = r[2], h = -1, l = e.length, u = 0; l > u; u += 4) {
							var c = e[u],
								p = e[u + 1],
								d = e[u + 2],
								f = e[u + 3] || a;
							(0 > h || h != f) && (h = f, s = i.lineStyle(2, f, 1, t.CapsStyle.NONE)), s.moveTo(c, p), s.lineTo(c + d, p)
						}
				}
				if (i) {
					...
					if (f.text) {
						...
						for (var g = f.text.toString(), y = g.split(/(?:\r\n|\r|\n)/), v = 0, $ = y.length; $ > v; v++) {
							null == a[c] && (s = {
								...
								charNum: 0,
								hasNextLine: !1
							}, a[c] = s, h = 0, u = 0, l = 0), u = r[24] == t.TextFieldType.INPUT ? r[0] : Math.max(u, f.style.size || r[0]);
							var m = !0;
							if ("" == y[v]) v == $ - 1 && (m = !1);
							else {
								var b = e(y[v], r, f.style);
								if (isNaN(o)) h += b, l += y[v].length, s.elements.push({
									width: b,
									text: y[v],
									style: f.style
								}), v == $ - 1 && (m = !1);
								else if (o >= h + b) s.elements.push({
									width: b,
									text: y[v],
									style: f.style
								}), h += b, l += y[v].length, v == $ - 1 && (m = !1);
								else {
									var x = 0,
										T = 0,
										_ = y[v],
									...
									for (var E = O.length, F = 0; E > x; x++) {
										var w = O[x].length,
											C = !1;
										if (1 == w && E - 1 > x) {
											var R = O[x].charCodeAt(0),
												S = O[x + 1].charCodeAt(0);
										...
										if (T + b > o)
											for (var D = O[x].match(/./g), L = 0, M = D.length; M > L; L++) {
												var w = D[L].length,
													A = !1;
												if (1 == w && M - 1 > L) {
							...
							m && (l++, s.hasNextLine = !0), v < y.length - 1 && (s.width = h, s.height = u, s.charNum = l, r[5] = Math.max(r[5], h), r[6] += u, c++)
						}
						p == n.length - 1 && s && (s.width = h, s.height = u, s.charNum = l, r[5] = Math.max(r[5], h), r[6] += u)
					} else s && (s.width = h, s.height = u, s.charNum = l, r[5] = Math.max(r[5], h), r[6] += u)
				}
				...
				for (var c = t.TextFieldUtils.$getHalign(this), p = 0, d = [], f = h, g = i[29]; g > f; f++) {
					...
					for (var $ = 0, m = y.elements.length; m > $; $++) {
						var b = y.elements[$],
							x = b.style.size || i[0];
						e.drawText(p, a + (v - x) / 2, b.text, b.style), b.style.underline && d.push(p, a + v / 2, b.width, b.style.textColor), p += b.width
					}
					a += v / 2 + i[1]
				}
				return d
	...
	var e = function() {
		...
		return e.$getStartLine = function(t) {
			var i = t.$TextField,
				...
				n = 0,
				o = i[4];
			return isNaN(o) || (o > r || r > o && (n = Math.max(i[28] - 1, 0), n = Math.min(i[29] - 1, n)), i[30] || (n = Math.max(i[28] - 1, 0), i[29] > 0 && (n = Math.min(i[29] - 1, n)))), n
...
! function(t) {
	var e = function() {
		...
		return t.encode = function(t) {
			...
			for (var h = new ArrayBuffer(e), l = new Uint8Array(h), u = 0; i > u; u += 4) n = lookup[t.charCodeAt(u)], o = lookup[t.charCodeAt(u + 1)], s = lookup[t.charCodeAt(u + 2)], a = lookup[t.charCodeAt(u + 3)], l[r++] = n << 2 | o >> 4, l[r++] = (15 & o) << 4 | s >> 2, l[r++] = (3 & s) << 6 | 63 & a;
			return h
		}, t
	}();
...
! function(t) {
	...
	var i = function() {
		...
		return i.prototype._setArrayBuffer = function(t) {
		...
		}, i.prototype.setArrayBuffer = function(t) {}, Object.defineProperty(i.prototype, "buffer", {
			get: function() {
			...
			if (void 0 === e && (e = 0), void 0 === r && (r = 0), 0 == r) r = this.bytesAvailable;
			else if (!this.validate(r)) return null;
			t ? t.validateBuffer(e + r) : t = new i(new ArrayBuffer(e + r));
			for (var n = 0; r > n; n++) t.data.setUint8(n + e, this.data.getUint8(this.position++))
			...
			var r;
			if (!(0 > e) && !(0 > i) && (r = 0 == i ? t.length - e : Math.min(t.length - e, i), r > 0)) {
				this.validateBuffer(r);
				for (var n = new DataView(t.buffer), o = r, s = 4; o > s; o -= s) this.data.setUint32(this._position, n.getUint32(e)), this.position += s, e += s;
			...
			for (var e = 0, i = this.stringToCodePoints(t), r = []; i.length > e;) {
				...
				if (this.inRange(n, 55296, 57343)) this.encoderError(n);
					...
					var o = void 0,
						s = void 0;
					for (this.inRange(n, 128, 2047) ? (o = 1, s = 192) : this.inRange(n, 2048, 65535) ? (o = 2, s = 224) : this.inRange(n, 65536, 1114111) && (o = 3, s = 240), r.push(this.div(n, Math.pow(64, o)) + s); o > 0;) {
			...
			for (var e, i = !1, r = 0, n = "", o = 0, s = 0, a = 0, h = 0; t.length > r;) {
				var l = t[r++];
				if (l == this.EOF_byte) e = 0 != s ? this.decoderError(i) : this.EOF_code_point;
				else if (0 == s) this.inRange(l, 0, 127) ? e = l : (this.inRange(l, 194, 223) ? (s = 1, h = 128, o = l - 192) : this.inRange(l, 224, 239) ? (s = 2, h = 2048, o = l - 224) : this.inRange(l, 240, 244) ? (s = 3, h = 65536, o = l - 240) : this.decoderError(i), o *= Math.pow(64, s), e = null);
				else if (this.inRange(l, 128, 191))
					if (a += 1, o += (l - 128) * Math.pow(64, s - a), a !== s) e = null;
					else {
						var u = o,
							c = h;
						o = 0, s = 0, a = 0, h = 0, e = this.inRange(u, c, 1114111) && !this.inRange(u, 55296, 57343) ? u : this.decoderError(i, l)
					}
				else o = 0, s = 0, a = 0, h = 0, r--, e = this.decoderError(i, l);
	...
	function e(t, e, i) {
		...
		if (r.__types__)
			for (var s = o.length, a = 0; s > a; a++) {
				var h = o[a]; - 1 == n.indexOf(h) && n.push(h)
			}
		r.__types__ = n
	}
	t.registerClass = e
...
! function(t) {
	function e(t, e, i) {
		...
		if (null != h) {
			...
			a = Object.getOwnPropertyDescriptor(h, i).set, o[i] = a, a.apply(e, r)
		}
	}
	...
	function i(t, e, i) {
		...
		if (null != s) {
			...
			return o = Object.getOwnPropertyDescriptor(s, i).get, r[i] = o, o.call(e)
		}
	}
