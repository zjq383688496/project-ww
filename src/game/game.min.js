	...
	var e = function(e) {
		...
		return __extends(r, e), Object.defineProperty(r.prototype, "bounces", {
			...
			var i = Math.abs(t),
				...
				l = e + 500 * t;
			if (0 > l || l > r)
				for (l = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;) l += t, t *= 0 > l || l > r ? s * o : s, n++;
		...
		return __extends(i, r), i.prototype.load = function(r) {
			...
			if (r.method != t.URLRequestMethod.GET && r.data)
				if (r.data instanceof t.URLVariables) {
					t.Capabilities.runtimeType == t.RuntimeType.WEB && n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
					var a = r.data;
					s = a.toString()
				} else t.Capabilities.runtimeType == t.RuntimeType.WEB && n.setRequestHeader("Content-Type", "multipart/form-data"), s = r.data;
			else;
			for (var l = r.requestHeaders.length, c = 0; l > c; c++) {
				var h = r.requestHeaders[c];
