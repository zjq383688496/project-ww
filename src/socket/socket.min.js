...
!function(t) {
	var e = function(e) {
		...
		o.prototype.readUTF = function() {
			var t;
			return this._type == o.TYPE_BINARY ? (this._readByte.position = 0,
		...
		o.prototype.writeBytes = function(e, o, n) {
			...
			this._writeByte.writeBytes(e, o, n),
		...
		o.prototype.readBytes = function(e, o, n) {
			...
			this._readByte.readBytes(e, o, n),
		...
		Object.defineProperty(o.prototype, "type", {
			...
			set: function(e) {
				this._type = e,
				e != o.TYPE_BINARY || this._writeByte || (this._readByte = new t.ByteArray,
	...
	e.TYPE_STRING = "webSocketTypeString",
	e.TYPE_BINARY = "webSocketTypeBinary",
	t.WebSocket = e,
